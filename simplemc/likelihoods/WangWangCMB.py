...
class PLKLikelihood(WangWangCMB):
    def __init__(self, matrices="PLK18"):
        ...
        elif matrices == 'WW_ΛCDM':
            # ΛCDM arXiv:1808.05724 (Calibrated with Planck TT,TE,EE + lowE )
        ...
        elif matrices == 'WW_wCDM':
            # wCDM arXiv:1808.05724 (Calibrated with Planck TT,TE,EE + lowE )
        ...
        elif matrices == 'WW_ΛCDM_OK':
            # ΛCDM + Ω_k  arXiv:1808.05724 (Calibrated with Planck TT,TE,EE + lowE )
